...
public class MainActivity extends AppCompatActivity implements Simulate.UpdateI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (RelativeLayout ) this.getLayoutInflater().inflate(R.layout.activity_main, null);
        ...
        mainLayout.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    public void onGlobalLayout() {
                        ...
                        rect.set(layout.leftMargin, layout.topMargin + 30, layout.rightMargin, layout.bottomMargin);
                        ...
                        rect = new Rect();
                        rect.set(layout.leftMargin + 21, layout.topMargin + 43, layout.rightMargin + track.getWidth()- 85, layout.bottomMargin + track.getHeight() - 70);
                        params.setBoundary(rect);
                        Log.d("Sample", "Track Left: " + rect.left + ", Top: " + rect.top + ", Right: " + rect.right + ", Bottom: " + rect.bottom);

                        simulator = new Simulate(params, MainActivity.this, false);
    ...
    public void updateUI(final VehicleParams params) {
        ...
        runOnUiThread(new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ((TextView) findViewById(R.id.pos)).setText("Position: (" + (params.getPosition().left + params.getPosition().right) + ", " + (params.getPosition().top + params.getPosition().bottom) + ")");
